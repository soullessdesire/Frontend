...
const Footer = lazy(() => {
  return import("../universal/Footer");
});
        ...
        <div className="margin_b" style={{ display: "flex" }}>
          <div className="about_divs">
            ...
            <p style={{ fontFamily: "Inria Sans", fontSize: "18px" }}>
              ...
              compassionate care. We aim to empower individuals to achieve their
              highest potential in physical health, mental well-being, and
              lasting sobriety, setting a benchmark for excellence in
        ...
        <div style={{ display: "flex" }} className="margin_b">
          ...
          <div className="about_divs margin-left">
            ...
            <p style={{ fontFamily: "Inria Sans", fontSize: "18px" }}>
              ...
              each patient’s unique needs, followed by developing individualized
              treatment plans. We integrate physical therapy, drug
              rehabilitation, and therapy services in a supportive environment.
              Progress is regularly monitored and treatment plans are adjusted
              as needed to ensure optimal, lasting outcomes.
            </p>
          </div>
        </div>
        <br />
